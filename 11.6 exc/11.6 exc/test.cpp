...
//
//
//	//s.resize(10);  //修改有效元素个数----------补 \0
//	//cout << s.size() << endl; 
//	//cout << s.capacity() << endl;
//
//	//s.resize(20);   //修改有效字符个数，补 'b'
//	//cout << s.size() << endl; 
//	//cout << s.capacity() << endl;
//
//	//s.resize(4);  
//	////减小有效字符个数，补 'b'-----实际'b'无用
//	//cout << s.size() << endl;
//	//cout << s.capacity() << endl;
//}
...
void test()
{
	...
	s.insert(3, 3, 'f');  //任意位置插入字符
	cout << s << endl;      //从索引为3 位置插入3个 'f'

	s.erase(3, 5);      //从索引为 3 位置删除5个字符
	cout << s << endl;
